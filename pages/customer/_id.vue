					...
					<v-col cols="12" md="8" class="justify-end d-flex">
						...
						<v-menu offset-y>
							<template v-slot:activator="{ on }">
								<v-btn color="primary" outlined class="ml-2" v-on="on">Dropdown</v-btn>
							</template>
							<v-list>
									<!-- Start edit user -->
                  <v-list-item>
...
export default {
    ...
    async downloadData() {
      ...
      element.setAttribute('href', 'data:json/application;charset=utf-8,' + encodeURIComponent(JSON.stringify(this.customer)));
