          ...
          <v-container>
            <v-row>
              <v-col cols="12" md="6" sm="12">
                <v-text-field v-model="userInfo.first" label="First name" required></v-text-field>
              </v-col>
              <v-col cols="12" md="6" sm="12">
                <v-text-field v-model="userInfo.last" label="Last name" required></v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="12" md="6" sm="12">
              ...
              <v-col cols="12" md="6" sm="12">
                <v-text-field v-model="userInfo.number" label="Number" required></v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="12" md="6" sm="12">
